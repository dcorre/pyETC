...
def load_optical_element(info_dict,element,element_type,norm=False,norm_val=1.):
   ...
   element_type: string
                 name of the element to be used (see '/transmissions/'element'/' for names)
   ...
   trans = resample(wvl,trans,info_dict['wavelength_ang'],0.,1.)
...
def telescope_efficiency(info_dict):
   ...
   for optical_element in info_dict['optical_design']['telescope']:
       for key,value in info_dict['optical_design']['telescope'][optical_element].items():
           Trans_tel*=load_optical_element(info_dict,optical_element,key)**value
   return Trans_tel
#-----------------------------------------------------------------------------------------------
...
def instrument_channel_efficiency(info_dict):
   ...
   for optical_element in info_dict['optical_design'][info_dict['channel']]:
       for key,value in info_dict['optical_design'][info_dict['channel']][optical_element].items():
           Trans_inst*=load_optical_element(info_dict,optical_element,key)**value
...
def set_total_optics_transmission(info_dict):
   ...
   """
   Trans_optics = telescope_efficiency(info_dict) * instrument_channel_efficiency(info_dict)
   return Trans_optics
#---------------------------------------------------------------------------------------------
